...
create table tb_user (id int8 generated by default as identity, username varchar(255),  password varchar(255),  roles varchar(255), primary key (id));
...
INSERT INTO tb_user(username, password, role) VALUES ('user', '$2a$10$78/nr/DOFr0ZRrInkYgz4eeixH6QGfBOA40WrFgHx3Ohwg4fBC80m','USER');
